...
/*
 * The ChatClient that can be run both as a console or a GUI
 */
public class ChatClient {
    ...
    private void display(String msg) {
        if (cg == null) {
            ...
            cg.append(msg + "\n");		// append to the ChatClientGUI JTextArea (or whatever)
        }
    }
     ...
     * > java ChatClient 
     * is equivalent to
     * > java ChatClient Anonymous 1500 localhost 
     * are eqquivalent
     * 
